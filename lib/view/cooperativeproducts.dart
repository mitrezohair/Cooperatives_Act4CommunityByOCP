...
import '../model/cooperative_model.dart';
import 'details_view.dart';

class CooperativeProducts extends StatelessWidget {
  CooperativeModel model;

  CooperativeProducts({required this.model});
  @override
  ...
  return GetBuilder<HomeViewModel>(
    builder: (controller) => Container(
      ...
      child: ListView.separated(
        itemCount: controller.productModelByCooperative.length,
        scrollDirection: Axis.vertical,
        itemBuilder: (context, index) {
          return GestureDetector(
            onTap: () {
              Get.to(
                DetailsView(model: controller.productModelByCooperative[index],),
                ...
                children: [
                  Container(
                    child: Container(
                        ...
                        child: Image.network(
                          controller.productModelByCooperative[index].image,
                          fit: BoxFit.fill,
                        )),
                  ),
                  SizedBox(
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        CustomText(
                          text: controller.productModelByCooperative[index].name,
                        ...
                        CustomText(
                          text: controller.productModelByCooperative[index].price.toString() +
                              " MAD",
                          color: primaryColor,
                          alignment: Alignment.bottomLeft,
                          fontSize: 16,
