...
class ManagingProducts extends StatelessWidget {
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      IconButton(
                                          onPressed: (){
                                            Get.to(UpdateProducts('${snapshot.data?.docs[index]['name']}','${snapshot.data?.docs[index]['price']}','${snapshot.data?.docs[index].id.toString()}'));
                                            controller.setidProductToUpdate('${snapshot.data?.docs[index].id.toString()}');
                                          } ,
                                      ...
                                      IconButton(
                                          onPressed: (){
                                            controller.deleteProducts('${snapshot.data?.docs[index].id.toString()}');
                                          } ,
